...
module.exports.inbound = (req, res) => {
  ...
  db.query(sql, [inboundValue.store_id, inboundValue.store_name, inboundValue.category, inboundValue.product_name, inboundValue.product_id, inboundValue.inbound_count, inboundValue.inbound_count, inboundValue.inbound_unit, inboundValue.inbound_unit_count, inboundValue.shift_id], (err, result) => {
    if (err) {
