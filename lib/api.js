...
module.exports.label_printAll = (req, res) => {
  // const availablePrinters =  escpos.Bluetooth.findPrinters();
  // const printers = await escpos.Bluetooth.findPrinters();
  // console.log(printers);
  const address = 'DC-0D-30-CD-43-E9';
  const channel = 1;
  ...
  // bluetoothDevice.open(function(err){
  ...
  // const printers = escpos.Bluetooth.findPrinters();
  // console.log(printers);
...
module.exports.getStore = (req, res) => {
  ...
  const sql = 'SELECT id AS store_id, name AS store_name FROM store WHERE vander_id = ?'
